...
function (atoms) {
var sJmol = this.jmolScriptCallback (J.c.CBK.SELECT);
this.setStatusChanged ("select", -1, atoms, false);
if (this.notifyEnabled (J.c.CBK.SELECT)) this.cbl.notifyCallback (J.c.CBK.SELECT,  Clazz.newArray (-1, [sJmol, atoms]));
}, "JU.BS");
